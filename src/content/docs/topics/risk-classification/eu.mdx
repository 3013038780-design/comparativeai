...
| --- | --- | --- |
| [EU AI Act](/rules/eu/ai-act/) | Arts. 5 / 6 / 50 / 51 | Four tiers + the GPAI track |
| [GPAI Code of Practice](/rules/eu/gpai-code-of-practice/) | Art. 56 | Presumption-of-conformity route for GPAI |
| [GDPR](/rules/eu/gdpr/) | Art. 35 | DPIA's independent "high-risk" determination |
| [DSA](/rules/eu/dsa/) | Art. 34 | VLOP systemic-risk assessment |
| [Digital Omnibus Proposal](/rules/eu/digital-omnibus-proposal/) | — | **Proposes to postpone the high-risk provisions to Dec 2027** |
| [Spain AESIA](/subnational/eu/spain-aesia/) | Member-state MSA | First dedicated AI authority in the EU |
| [France CNIL AI](/subnational/eu/france-cnil-ai/) | GDPR × AI | Among the most active DPAs |
...
Eight explicit prohibitions (see the [AI Act Rules page](/rules/eu/ai-act/)):
...
See the [AI Act Rules page](/rules/eu/ai-act/) for the full matrix of obligations.
