---
title: United States — Risk Classification
description: Federal-level "risk management" vs. state-level "high-risk AI system" tiering in the United States.
sidebar:
  order: 3
  label: United States
---
...
| --- | --- | --- |
| [NIST AI RMF 1.0](/rules/us/nist-ai-rmf/) (2023) | Technical specification | Organised around a risk-management *process*, not graded risk tiers |
| [EO 14179](/rules/us/eo-14179-removing-barriers-ai/) (Jan 2025) | Executive order | Revokes EO 14110 and reshapes the federal posture |
| [Trump AI Action Plan](/rules/us/trump-ai-action-plan/) (Jul 2025) | Strategy | Deregulation + global dominance agenda |
| [EO 14365](/rules/us/eo-14365-national-ai-framework/) (Dec 2025) | Executive order | **Attempts to preempt state AI laws** |
| [Colorado AI Act](/subnational/us/colorado-ai-act/) (in force Jun 30, 2026) | State law | **First US state law to introduce "High-Risk AI System"** |
| [**California SB 53**](/subnational/us/california-sb-53-frontier-ai/) (Jan 1, 2026) | State law | **Frontier-AI transparency** |
| [**Texas TRAIGA**](/subnational/us/texas-traiga/) (Jan 1, 2026) | State law | Prohibits harmful uses |
| [NYC Local Law 144](/subnational/us/nyc-local-law-144/) (2023) | Municipal law | Employment-specific |

## Three layers of US risk classification

### Federal: process-oriented, not tiered
...
1. **A "consequential decision" high-risk tier** (Democratic model):
   [Colorado AI Act](/subnational/us/colorado-ai-act/) (in force Jun 30, 2026) — a single "High-Risk" category covering eight types of consequential decision.
2. **A compute-threshold frontier-model tier** (Democratic + tech-industry model):
   [California SB 53](/subnational/us/california-sb-53-frontier-ai/) (Jan 1, 2026) — models above 10²⁶ FLOP must publish transparency reports and file critical incident reports.
3. **A prohibited-use tier** (Republican model):
   [Texas TRAIGA](/subnational/us/texas-traiga/) (Jan 1, 2026) — prohibits specific harmful uses without classifying general AI systems.
...
### Sector- and use-case-specific regimes
...
- **Employment**: [NYC LL 144](/subnational/us/nyc-local-law-144/) + EEOC 2023 guidance.
