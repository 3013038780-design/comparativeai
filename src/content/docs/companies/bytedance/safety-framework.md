...
description: ByteDance's "embedded" AI safety framework — the national regulatory tier absorbing corporate self-governance (snapshot 2026-06-28)
sidebar:
  order: 3
...
| --- | --- | --- |
| **Algorithm-filing layer** | CAC filing and change-filing for Doubao, Coze, Volcano Engine, etc. | [*Generative AI Interim Measures*](/rules/china/generative-ai-interim-measures/) Art. 17 · [*Algorithm Recommendation Provisions*](/rules/china/algorithm-recommendation-provisions/) |
| **National-standard compliance layer** | Full-line compliance with TC260-003 (basic requirements) + GB 45438-2025 (labeling) | [TC260-003-2024](/rules/china/tc260-gen-ai-security-basic-requirements/) · [GB 45438-2025](/rules/china/gb-45438-2025-ai-content-labeling-standard/) |
| **Governance-framework alignment layer** | *AI Safety Governance Framework* 1.0 / 2.0 guiding corporate-level execution | [Safety Governance Framework 1.0 / 2.0](/rules/china/ai-safety-governance-framework/) |
...
- Top-level rules: [*AI Safety Governance Framework* 1.0 / 2.0](/rules/china/ai-safety-governance-framework/)
...
- Peer comparison: [Anthropic / safety-framework (RSP v3)](/companies/anthropic/safety-framework/)
  · [OpenAI / safety-framework (Preparedness)](/companies/openai/safety-framework/)
  · [DeepMind / safety-framework (FSF)](/companies/google-deepmind/safety-framework/)
