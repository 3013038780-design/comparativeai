---
title: Model Card
description: Archive of technical disclosures for Doubao / Seed — Chinese filing materials vs. Western Model Cards as "asymmetric transparency" (snapshot 2026-06-28)
sidebar:
  order: 2
...
- Top-level rules: [*Generative AI Interim Measures*](/rules/china/generative-ai-interim-measures/) Art. 17 (filing)
  · [TC260-003-2024](/rules/china/tc260-gen-ai-security-basic-requirements/)
- Peer comparison: [Anthropic / model-card](/companies/anthropic/model-card/)
  · [OpenAI / model-card](/companies/openai/model-card/)
  · [DeepMind / model-card](/companies/google-deepmind/model-card/)
