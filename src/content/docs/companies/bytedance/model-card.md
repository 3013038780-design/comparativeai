---
title: 模型卡
description: 豆包大模型 / Seed 系列技术披露归档 — 中国备案材料 vs. 西方 Model Card 的"不对称透明"（2026-04-23 快照）
sidebar:
  order: 2
...
- 顶层规则：[《生成式 AI 暂行办法》](/rules/china/generative-ai-interim-measures/) 第 17 条（备案）
  · [TC260-003-2024](/rules/china/tc260-gen-ai-security-basic-requirements/)
- 同类对比：[Anthropic / model-card](/companies/anthropic/model-card/)
  · [OpenAI / model-card](/companies/openai/model-card/)
  · [DeepMind / model-card](/companies/deepmind/model-card/)
