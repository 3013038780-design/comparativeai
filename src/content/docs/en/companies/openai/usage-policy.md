...
- **Cross-references**: [OpenAI overview](./), [safety framework](./safety-framework/), [transparency report](./transparency-report/), [Anthropic Usage Policy](/en/companies/anthropic/usage-policy/), [company practice overview](/en/companies/)
