---
title: Usage Policy
description: DeepSeek usage policy archive — the interplay between service-side AUP, API terms, MIT-licensed open weights, and China's compliance baseline (2026-04-23)
sidebar:
  order: 1
