...
description: DeepSeek's "minimalist + embedded" safety posture — an open-source path with no RSP / Preparedness / FSF counterpart (2026-04-23)
sidebar:
  order: 3
...
- This site: [en/rules/china/generative-ai-interim-measures](/en/rules/china/generative-ai-interim-measures/)
  · [en/rules/china/tc260-gen-ai-security-basic-requirements](/en/rules/china/tc260-gen-ai-security-basic-requirements/)
  · [en/rules/china/ai-safety-governance-framework](/en/rules/china/ai-safety-governance-framework/)
