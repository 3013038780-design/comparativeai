---
title: Model Card
description: DeepSeek model technical report archive — the "technical-report-as-model-card" practice across V2/V3/R1/V3.1 and the VL/Coder/Math series (2026-04-23)
sidebar:
  order: 2
