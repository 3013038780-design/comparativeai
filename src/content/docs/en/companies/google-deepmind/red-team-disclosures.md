...
- Comparison: [Anthropic Red-Team](/en/companies/anthropic/red-team-disclosures/), [OpenAI Red-Team](/en/companies/openai/red-team-disclosures/)
- UK AISI: [UK AI Safety Institute](/en/policies/uk/aisi/)
- Frontier Model Forum: [Industry self-regulation](/en/industry/frontier-model-forum/)
