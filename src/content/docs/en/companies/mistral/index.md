---
title: Mistral AI
description: Mistral AI company profile and policy-document snapshot (2026-04-22)
sidebar:
  order: 6
  label: Mistral AI
...
- **European Union (home jurisdiction)**:
  - **Full signatory of the [GPAI Code of Practice](/en/rules/eu/gpai-code-of-practice/)** (first wave, 2025-08-01)
  - **Mistral Large 2 already exceeded the 10^25 FLOP threshold**, triggering AI Act **systemic-risk GPAI** obligations
  - Close collaboration with **[CNIL](/en/subnational/eu/france-cnil-ai/)** (France's data-protection authority); Mistral is expected to benefit once France designates its national AI Act MSA
