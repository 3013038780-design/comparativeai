...
Citation and disclaimers are handled on a separate page: [Citation and disclaimer](/en/methodology/citation-disclaimer/).
...
- **Codes of Practice** (such as the [GPAI Code of Practice](/en/rules/eu/gpai-code-of-practice/)): authorised by Article 56 of the AI Act; signing yields a compliance presumption. They function as a **transitional compliance path while the relevant hENs are not yet in place**.
...
- **Member-State DPA / MSA enforcement:** the operational machinery that lands hard law in practice ([France CNIL](/en/subnational/eu/france-cnil-ai/), [Spain AESIA](/en/subnational/eu/spain-aesia/), Italy's Garante, Ireland's DPC, and so on).
...
Items that resist easy classification are logged separately: [Legal-hierarchy boundary cases](/en/methodology/citation-disclaimer/#hard-soft-edge-cases). Currently recorded:
...
- Follow the site's terminology table (see [Citation and disclaimer](/en/methodology/citation-disclaimer/)).
...
**Version display at the bottom of each page** uses Starlight's `lastUpdated` feature, which is based on Git commit time. Significant revisions are also recorded in the [Updates log](/en/updates/).
