...
| --- | --- | --- | --- |
| Comprehensive privacy law | [PIPL](/en/rules/china/personal-info-protection-law/) (2021) | **No federal law** (state-law patchwork) | [GDPR](/en/rules/eu/gdpr/) (2018) |
| AI-specific data provisions | [Generative AI Interim Measures art. 7](/en/rules/china/generative-ai-interim-measures/) | None | [AI Act art. 10](/en/rules/eu/ai-act/) |
| **Mandatory training-data summary** | None | None | **[AI Act art. 53](/en/rules/eu/ai-act/) — world's first** |
...
| --- | --- | --- | --- | --- |
| [OpenAI](/en/companies/openai/) | Web + **licensing** (FT, Axel Springer, News Corp) | Low | **Multiple paid licences** | Plans to publish data summary |
| [Anthropic](/en/companies/anthropic/) | Web + licensed | Medium (partial detail) | Fewer public licence deals | Data summary published |
| [Google DeepMind](/en/companies/google-deepmind/) | Google Search index + YouTube + licences | Low | Pre-existing media relationships | Publication planned |
| [Meta Llama](/en/companies/) | Web + Meta platform data (disputed) | **Technical reports include considerable detail** | Few paid licences | Already disclosed |
| [Mistral](/en/companies/mistral/) | Web + partners | Medium | EU copyright compliance | Published (GPAI CoP requirement) |
| [Alibaba Qwen](/en/companies/alibaba/) | Chinese-first + partners | **Technical reports include detail** | Unclear | No CoP signature |
| [Baidu ERNIE](/en/companies/baidu/) | Chinese-first + partners | Partial | Unclear | No CoP signature |
| [DeepSeek](/en/companies/deepseek/) | Web | **Detailed technical reports** | Unclear | No CoP signature |
...
- **EU**: [GDPR](/en/rules/eu/gdpr/); [AI Act](/en/rules/eu/ai-act/) arts. 10 / 53; [GPAI Code of Practice](/en/rules/eu/gpai-code-of-practice/) Chapter 2; DSM Copyright Directive.
- **China**: [PIPL](/en/rules/china/personal-info-protection-law/), [DSL](/en/rules/china/data-security-law/), [CSL](/en/rules/china/cybersecurity-law/); [Generative AI Interim Measures](/en/rules/china/generative-ai-interim-measures/) art. 7; [TC260-003-2024](/en/rules/china/tc260-gen-ai-security-basic-requirements/) (≤ 5% unlawful content in training corpora).
- **United States**: [NIST AI RMF](/en/rules/us/nist-ai-rmf/); state laws (CCPA/CPRA, Illinois BIPA, Tennessee ELVIS Act, etc.); **no federal AI-specific data law**.

### Related companies

See the "training data" analysis on individual company pages: [OpenAI](/en/companies/openai/) / [Anthropic](/en/companies/anthropic/) / [Mistral](/en/companies/mistral/) (EU-compliance model) / [DeepSeek](/en/companies/deepseek/) (open-source-transparency model) / [Alibaba Qwen](/en/companies/alibaba/) (Chinese + open).
