...
| --- | --- |
| [GDPR](/en/rules/eu/gdpr/) | Lawful basis for personal data; purpose limitation |
| [EU AI Act](/en/rules/eu/ai-act/) | Art. 10 data governance + art. 53 training-data summary |
| [GPAI Code of Practice](/en/rules/eu/gpai-code-of-practice/) | Chapter 2 copyright + standardised training-data summary |
| DSM Copyright Directive (2019/790) | TDM exception (arts. 3, 4) |
| [DSA](/en/rules/eu/dsa/) | VLOP visibility of content used for training |
| [France CNIL AI](/en/subnational/eu/france-cnil-ai/) | GDPR × AI training-data compliance guidance (12+ papers) |
