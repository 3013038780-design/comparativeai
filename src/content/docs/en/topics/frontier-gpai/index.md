...
| Technical standard | [TC260-003-2024](/en/rules/china/tc260-gen-ai-security-basic-requirements/) | NIST AI RMF (voluntary) | CEN-CENELEC harmonised standards (in development) |
| Code of conduct | None | 2023 White House Voluntary Commitments | **[GPAI Code of Practice](/en/rules/eu/gpai-code-of-practice/)** (finalised Jul 10, 2025) |
...
- **In practice**: [Mistral](/en/companies/mistral/)'s flagship uses the MRL licence (not fully open source), deflecting full open-source obligations.
- **[DeepSeek](/en/companies/deepseek/)'s all-out open release** → **once weights ship, there is no "pause" to invoke**.
...
- Frontier-lab self-regulation has **loosened across the board** in 2025–2026 (see [company pages](/en/companies/)):
...
| --- | --- | --- | --- |
| [Anthropic](/en/companies/anthropic/) | **RSP v3** (Feb 2026) | ASL tiers (modelled on BSL) | **Revoked pause commitment**; separates "unilateral" vs. "industry-wide" |
| [OpenAI](/en/companies/openai/) | **Preparedness v2** (Apr 2025) | Threat categories × High / Critical | **Simplified thresholds** (dropped Low / Medium) |
| [Google DeepMind](/en/companies/google-deepmind/) | **FSF v3** (Apr 2026) | Critical Capability Levels (CCL) | **Expanded**: new TCLs + manipulation CCL |
| [Mistral](/en/companies/mistral/) | **No independent framework** | Open source + GPAI CoP signatory | — |
| [xAI](/en/companies/xai/) | **Weak / absent** | — | Publicly **rejects** the self-regulation paradigm |
| [Meta](/en/companies/) | Frontier AI Framework | Similar methodology | Ongoing iteration |
...
3. **"Abandon the US and EU markets"**: [DeepSeek](/en/companies/deepseek/) and most Chinese firms focus on the domestic market.
...
### EU
- [EU AI Act](/en/rules/eu/ai-act/) arts. 51–56; Annexes XI / XII / XIII
- [GPAI Code of Practice](/en/rules/eu/gpai-code-of-practice/) (Jul 2025)
- [Digital Omnibus Proposal](/en/rules/eu/digital-omnibus-proposal/) (Nov 2025)

### China
- [Generative AI Interim Measures](/en/rules/china/generative-ai-interim-measures/)
- [TC260-003-2024](/en/rules/china/tc260-gen-ai-security-basic-requirements/)
- [AI Safety Governance Framework 1.0 / 2.0](/en/rules/china/ai-safety-governance-framework/)
- [Anthropomorphic Interaction Services Measures](/en/rules/china/anthropomorphic-interaction-services/)

### United States
- [NIST AI RMF + GenAI Profile](/en/rules/us/nist-ai-rmf/)
- [EO 14179](/en/rules/us/eo-14179-removing-barriers-ai/) / [EO 14365](/en/rules/us/eo-14365-national-ai-framework/)
- [California SB 53](/en/subnational/us/california-sb-53-frontier-ai/)
