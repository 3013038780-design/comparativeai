...
> **⚠️ Hierarchy note**: This instrument is a **departmental rule**, jointly issued by four ministries. It is **neither** a NPC law **nor** a State Council administrative regulation. Its penalties land via reference to upstream laws such as the Cybersecurity Law. See [Index of Chinese Rules](/en/rules/china/#the-legal-hierarchy-at-a-glance).
...
- **GB 45438-2025**: the mandatory national standard defining the implicit-label fields. This site classifies it as **soft law** ([see reasoning](/en/methodology/#hard-vs-soft)) while flagging its mandatory character.
