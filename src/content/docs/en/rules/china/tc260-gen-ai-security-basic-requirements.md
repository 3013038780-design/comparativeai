...
> **⚠️ Hierarchy note**: Nominally a **voluntary technical specification** (Level 5, the lowest rank); but because CAC uses it as the yardstick for filing (*备案*) review, failing it means no filing — which means no public-facing service — so it operates as a **de facto hard constraint**. This is the canonical case for the "hard law / soft law" categorization framework on this site. See [Index of Chinese Rules](/en/rules/china/#the-legal-hierarchy-at-a-glance) and [Methodology §2](/en/methodology/#hard-vs-soft).
...
This is the textbook case in this site's [hard-law / soft-law classification](/en/methodology/#hard-vs-soft) of "soft law with hard constraint."
