...
> **⚠️ Hierarchy note**: This instrument is a **law enacted by the NPC Standing Committee** (Level 1) — the highest rank. Alongside CSL and PIPL, it forms the so-called "three data laws" of China. See [Index of Chinese Rules](/en/rules/china/#the-legal-hierarchy-at-a-glance).
