...
| --- | --- | --- | --- | --- |
| **🇪🇺 欧盟** | **用途 / 场景**（附件 III 清单）+ **算力**（GPAI 10²⁵ FLOP） | **4 层**（禁止 / 高风险 / 有限风险 / 最低风险）+ GPAI 独立通道 | 清单列举 + 算力阈值 | [AI Act 第 5 / 6 / 50 / 51 条](/zh/rules/eu/ai-act/) |
| **🇨🇳 中国** | **服务类型**（深度合成 / 生成式 / 算法推荐 / 拟人化）+ **算力 / 用户规模** | 事实分层（各部门规章独立）| 场景清单 + 100 万用户门槛 + 备案 | [《生成式 AI 办法》](/zh/rules/china/generative-ai-interim-measures/) · [TC260-003](/zh/rules/china/tc260-gen-ai-security-basic-requirements/) · [人工智能安全治理框架](/zh/rules/china/ai-safety-governance-framework/) |
| **🇺🇸 美国** | **联邦：流程化**（NIST AI RMF 按 context）**/ 州：后果性决策 + 算力** | 联邦无统一；州各异 | 州法独立定义 | [NIST AI RMF](/zh/rules/us/nist-ai-rmf/) + [Colorado AI Act](/zh/subnational/us/colorado-ai-act/) + [California SB 53](/zh/subnational/us/california-sb-53-frontier-ai/) |
...
- **学界批评**：[DeepSeek 2025-01 冲击](/zh/companies/deepseek/) 证明算力门槛**不等于能力门槛**——
...
| --- | --- | --- | --- | --- |
| [Anthropic](/zh/companies/anthropic/) | ✅ GPAI + 系统性风险 | ✅ 10²⁶ FLOP 前沿 | 未入中国 | **[RSP v3](https://www.anthropic.com/news/responsible-scaling-policy-v3)** ASL 等级（映射多数法规）|
| [OpenAI](/zh/companies/openai/) | ✅ GPAI + 系统性风险 | ✅ | 未入中国 | **[Preparedness Framework v2](https://openai.com/index/updating-our-preparedness-framework/)** 高 / 关键阈值 |
| [Google DeepMind](/zh/companies/google-deepmind/) | ✅ GPAI + 系统性风险 | ✅ | 未入中国 | **[FSF v3](https://deepmind.google/blog/strengthening-our-frontier-safety-framework/)** Critical + Tracked CLs |
| [Mistral](/zh/companies/mistral/) | ✅ GPAI + 系统性风险 | ⚠️（Mistral Large 3 约 10²⁶）| 未入中国 | **GPAI CoP 签署 + 开源透明** |
| [Meta](/zh/companies/) | ✅ 部分 | ✅ | 未入中国 | Frontier AI Framework v2 |
| [字节豆包](/zh/companies/bytedance/) | 未入 | 未入 | ✅ 深度合成 + 生成式 | **CAC 备案 + TC260-003 合规** |
| [阿里 Qwen](/zh/companies/alibaba/) | 开源模型下载 → 欧盟潜在义务 | 开源下载 → 加州潜在 | ✅ | 开源 + 国内备案 |
...
- **🇪🇺 欧盟**：[AI Act](/zh/rules/eu/ai-act/) 第 5 / 6 / 50 / 51 条、[GPAI Code of Practice](/zh/rules/eu/gpai-code-of-practice/)、[Digital Omnibus Proposal](/zh/rules/eu/digital-omnibus-proposal/)
- **🇨🇳 中国**：[生成式 AI 办法](/zh/rules/china/generative-ai-interim-measures/) 第 3 条、[TC260-003-2024](/zh/rules/china/tc260-gen-ai-security-basic-requirements/)、[AI 安全治理框架 1.0/2.0](/zh/rules/china/ai-safety-governance-framework/)、[拟人化互动服务办法](/zh/rules/china/anthropomorphic-interaction-services/)
- **🇺🇸 美国**：[NIST AI RMF](/zh/rules/us/nist-ai-rmf/)、[Colorado AI Act](/zh/subnational/us/colorado-ai-act/)、[California SB 53](/zh/subnational/us/california-sb-53-frontier-ai/)、[Texas TRAIGA](/zh/subnational/us/texas-traiga/)、[NYC LL 144](/zh/subnational/us/nyc-local-law-144/)

### 相关公司

参见 [公司实践](/zh/companies/) 各家公司页的"安全框架"部分（[Anthropic](/zh/companies/anthropic/) / [OpenAI](/zh/companies/openai/) / [Google DeepMind](/zh/companies/google-deepmind/) 分析最深）。
