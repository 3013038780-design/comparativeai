...
| --- | --- | --- | --- |
| 综合隐私法 | [PIPL](/zh/rules/china/personal-info-protection-law/) (2021) | **无联邦法**（州法拼图） | [GDPR](/zh/rules/eu/gdpr/) (2018) |
| AI 专项数据条款 | [生成式 AI 办法第 7 条](/zh/rules/china/generative-ai-interim-measures/) | 无 | [AI Act 第 10 条](/zh/rules/eu/ai-act/) |
| **强制训练数据摘要** | 无 | 无 | **[AI Act 第 53 条](/zh/rules/eu/ai-act/)（全球首个）** |
...
| --- | --- | --- | --- | --- |
| [OpenAI](/zh/companies/openai/) | 互联网 + **许可**（FT、Axel Springer、News Corp）| 低 | **多家付费许可** | 计划发布数据摘要 |
| [Anthropic](/zh/companies/anthropic/) | 互联网 + 授权 | 中（含部分细节） | 较少公开许可交易 | 发布数据摘要 |
| [Google DeepMind](/zh/companies/google-deepmind/) | Google 搜索索引 + YouTube + 许可 | 低 | 既有媒体关系 | 计划发布 |
| [Meta Llama](/zh/companies/) | 互联网 + Meta 平台数据（争议）| **技术报告含相当细节** | 少付费许可 | 已有披露 |
| [Mistral](/zh/companies/mistral/) | 互联网 + 合作方 | 中 | 欧盟版权合规 | 已发布（GPAI CoP 要求）|
| [阿里 Qwen](/zh/companies/alibaba/) | 中文优先 + 合作 | **技术报告含详细** | 不明确 | 未签 CoP |
| [百度 ERNIE](/zh/companies/baidu/) | 中文优先 + 合作 | 部分 | 不明确 | 未签 CoP |
| [DeepSeek](/zh/companies/deepseek/) | 互联网 | **技术报告详细** | 不明确 | 未签 CoP |
...
- **🇪🇺 欧盟**：[GDPR](/zh/rules/eu/gdpr/)、[AI Act](/zh/rules/eu/ai-act/) 第 10 / 53 条、[GPAI Code of Practice](/zh/rules/eu/gpai-code-of-practice/) Chapter 2、DSM 版权指令
- **🇨🇳 中国**：[PIPL](/zh/rules/china/personal-info-protection-law/) · [DSL](/zh/rules/china/data-security-law/) · [CSL](/zh/rules/china/cybersecurity-law/)、[生成式 AI 办法](/zh/rules/china/generative-ai-interim-measures/) 第 7 条、[TC260-003-2024](/zh/rules/china/tc260-gen-ai-security-basic-requirements/)（语料合法性 ≤5% 非法）
- **🇺🇸 美国**：[NIST AI RMF](/zh/rules/us/nist-ai-rmf/)；州法（CCPA/CPRA、Illinois BIPA、Tennessee ELVIS Act 等）；**无联邦 AI 专项数据法**

### 相关公司

参见各公司页的"训练数据"分析：[OpenAI](/zh/companies/openai/) / [Anthropic](/zh/companies/anthropic/) / [Mistral](/zh/companies/mistral/)（欧盟合规样板）/ [DeepSeek](/zh/companies/deepseek/)（开源透明样板）/ [阿里 Qwen](/zh/companies/alibaba/)（中文 + 开源）
