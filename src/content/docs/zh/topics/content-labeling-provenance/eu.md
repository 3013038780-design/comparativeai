...
- **实施守则**：欧盟委员会于 **2026-06-10** 发布最终版[《AI 生成内容透明度行为守则》](/zh/rules/eu/synthetic-content-code/)，以自愿方式支持第 50 条合规。
...
最终自愿守则把第 50 条转化为关于机读标记、部署者披露、聊天机器人告知和欧盟统一视觉图标的实务措施。
签署守则不取代 AI Act，也不当然免除执法责任；未签署者可通过其他充分方式证明合规。
