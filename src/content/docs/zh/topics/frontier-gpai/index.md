...
| 技术标准 | [TC260-003-2024](/zh/rules/china/tc260-gen-ai-security-basic-requirements/) | NIST AI RMF（自愿） | CEN-CENELEC 协调标准（制定中） |
| 行为守则 | 无 | 2023 白宫 Voluntary Commitments | **[GPAI Code of Practice](/zh/rules/eu/gpai-code-of-practice/)**（2025-07-10 定稿） |
...
- **实务**：[Mistral](/zh/companies/mistral/) 旗舰用 MRL 许可（非完全开源），规避全面开源义务
- **[DeepSeek](/zh/companies/deepseek/) 极限开源** → **模型权重发布即不可撤销**，任何监管"暂停"失效
- **学术争议**：Meta / Mistral 主张开源更透明；Anthropic / OpenAI 主张闭源更可控

### 3. **行业自律 vs. 硬法约束**

- 2025-2026 前沿实验室自律**整体松动**（见 [公司实践](/zh/companies/)）：
...
| --- | --- | --- | --- |
| [Anthropic](/zh/companies/anthropic/) | **RSP v3** (2026-02) | ASL 等级（类似 BSL） | **撤销 pause 承诺**；分"单方 vs 行业共同" |
| [OpenAI](/zh/companies/openai/) | **Preparedness v2** (2025-04) | 威胁类别 × High/Critical | **简化阈值**（删除 Low/Medium）|
| [Google DeepMind](/zh/companies/google-deepmind/) | **FSF v3** (2026-04) | Critical Capability Levels (CCL) | **扩展**：新增 TCL + 操纵 CCL |
| [Mistral](/zh/companies/mistral/) | **无独立框架** | 开源 + GPAI CoP 签署 | — |
| [xAI](/zh/companies/xai/) | **弱 / 无对标文档** | — | 公开**拒绝**自律范式 |
| [Meta](/zh/companies/) | Frontier AI Framework | 类似方法论 | 持续演进 |
...
3. **"放弃欧美市场"**：[DeepSeek](/zh/companies/deepseek/) / 大多数中国公司专注国内
...
### EU
- [EU AI Act](/zh/rules/eu/ai-act/) 第 51-56 条、附件 XI/XII/XIII
- [GPAI Code of Practice](/zh/rules/eu/gpai-code-of-practice/) (2025-07)
- [Digital Omnibus Proposal](/zh/rules/eu/digital-omnibus-proposal/) (2025-11)

### 中国
- [生成式 AI 暂行办法](/zh/rules/china/generative-ai-interim-measures/)
- [TC260-003-2024](/zh/rules/china/tc260-gen-ai-security-basic-requirements/)
- [AI 安全治理框架 1.0/2.0](/zh/rules/china/ai-safety-governance-framework/)
- [拟人化互动服务办法](/zh/rules/china/anthropomorphic-interaction-services/)

### 美国
- [NIST AI RMF + GenAI Profile](/zh/rules/us/nist-ai-rmf/)
- [EO 14179](/zh/rules/us/eo-14179-removing-barriers-ai/) / [EO 14365](/zh/rules/us/eo-14365-national-ai-framework/)
- [California SB 53](/zh/subnational/us/california-sb-53-frontier-ai/)
