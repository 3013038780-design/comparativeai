...
originalUrl: https://www.cac.gov.cn/2022-01/04/c_1642894606364259.htm
relatedTopics:
  - risk-classification
...
- **《深度合成规定》(2023)**：本规定第二条第(一)项"生成合成类算法"**被深度合成规定接手细化**，
  备案程序沿用本规定
  见 [deep-synthesis-provisions](/zh/rules/china/deep-synthesis-provisions/)
- **《生成式 AI 暂行办法》(2023)**：生成式 AI 服务的备案与安全评估义务**直接引用**本规定
  见 [generative-ai-interim-measures](/zh/rules/china/generative-ai-interim-measures/)
...
> https://comparativeai.org/zh/rules/china/algorithm-recommendation-provisions/
