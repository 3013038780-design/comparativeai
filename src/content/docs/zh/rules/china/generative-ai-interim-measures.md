...
### 截至 2026 年 6 月 30 日的备案实践

国家网信办 2026 年 5 月 13 日公告显示，2026 年 3—4 月新增 **72 款生成式人工智能服务完成国家备案**，另有 **49 款直接调用已备案模型的应用或功能完成地方登记**。截至 4 月 30 日，累计 **868 款服务完成备案**、**530 款应用或功能完成登记**。

这进一步确认了两条实施路径：

- 具有舆论属性或社会动员能力的生成式 AI 服务提供者，通过属地网信部门履行备案程序；
- 通过 API 或其他方式直接调用已备案模型的下游应用或功能，通常办理地方**登记**，而不是重复基础模型的国家备案。

已经上线的产品应在显著位置或详情页注明所使用的模型名称、备案号或上线编号。公告中的累计数量反映行政实施情况，并不扩大第十七条的实体适用范围。
...
- **《算法推荐规定》(2022)**：本办法引用其备案程序，形成"一套备案、多法共用"
  见 [algorithm-recommendation-provisions](/zh/rules/china/algorithm-recommendation-provisions/)
- **《标识办法》(2025)**：标识义务的技术实施细则
  见 [biaozhi-banfa](/zh/rules/china/biaozhi-banfa/)
...
| 2023-08-15 | 生效 |
| 2026-04-21 | 本站首次归档 |
| 2026-05-13 | 网信办公布截至 4 月 30 日累计 868 款服务备案、530 款下游应用或功能登记 |
...
> https://comparativeai.org/zh/rules/china/generative-ai-interim-measures/
