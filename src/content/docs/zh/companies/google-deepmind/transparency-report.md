...
1. **[Google Transparency Report](https://transparencyreport.google.com/)**（2010 起）——
   legacy，政府请求、版权删除等
2. **[Responsibility & Safety Hub](https://deepmind.google/zh/about/responsibility-safety/)**（DeepMind 维护）——
...
[deepmind.google/zh/about/responsibility-safety](https://deepmind.google/zh/about/responsibility-safety/) 是
...
- EU AI Act 合规：[EU AI Act](/zh/rules/eu/ai-act/)
- DSA 透明度义务：[EU DSA](/zh/rules/eu/dsa/)
- Ranking Digital Rights 方法：[学术参考](https://rankingdigitalrights.org/)
