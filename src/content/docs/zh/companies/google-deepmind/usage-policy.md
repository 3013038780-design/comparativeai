...
4. **Responsible AI Practices / Responsibility & Safety Hub**（研究与工程指引，[deepmind.google/zh/about/responsibility-safety](https://deepmind.google/zh/about/responsibility-safety/)）
...
[deepmind.google/zh/about/responsibility-safety](https://deepmind.google/zh/about/responsibility-safety/)
...
- 公司层总览与 FSF 全景：[Google DeepMind index](/zh/companies/google-deepmind/)
- 模型级能力披露：[Gemini Model Cards](./model-card/)
- 安全框架（FSF）演进：[Safety Framework](./safety-framework/)
- 对比：[Anthropic AUP](/zh/companies/anthropic/usage-policy/)、[OpenAI Usage Policies](/zh/companies/openai/usage-policy/)
- 方法论：[公司归属规则](/zh/methodology/#company-attribution)
